...
export class ChooseCharacter extends Scene {
  ...
  create() {
    ...
    this.peterPepper = this.add
      .image(100, centerY, "peter-pepper")
      .setScale(3, 3)
      .setFrame(2);
    this.logo = this.add.image(centerX, 175, "burgerlogo").setScale(5, 5);
    this.player1Info = this.add
      .image(centerX - 200, centerY, "player1Info")
      .setScale(3, 3);
    this.player2Info = this.add
      .image(centerX + 200, centerY, "player2Info")
      .setScale(3, 3);
    this.startButton = this.add
      .image(centerX, 800, "startButton")
      .setScale(5, 5)
      .setFrame(0)
      .setInteractive();
    this.chooseSausage1 = this.add
      .image(centerX - 200, 600, "chooseSausage")
      .setScale(3, 3)
      .setFrame(0)
      .setInteractive()
      .setName("sausage");
    this.chooseSausage2 = this.add
      .image(centerX + 200, 600, "chooseSausage")
      .setScale(3, 3)
      .setFrame(0)
      .setInteractive()
    ...
    this.choosePeter2 = this.add
      .image(centerX + 200, 650, "choosePeter")
      .setScale(3, 3)
      .setFrame(0)
      .setInteractive()
      .setName("peter-pepper");
    this.choosePeter1 = this.add
      .image(centerX - 200, 650, "choosePeter")
      .setScale(3, 3)
      .setFrame(0)
      .setInteractive()
    ...
    for (let i = 0; i < buttons.length; i++) {
      ...
      buttons[i].on("pointerdown", () => {
        ...
        if (i / 2 == 0) {
          player1name = buttons[i].name;
        } else {
          player2name = buttons[i].name;
        }
      });
